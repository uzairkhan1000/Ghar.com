        ...
        <div class="row">
            ...
            <div class="col-sm-4 text-center">
                <div class="info-box">
                    ...
                    <ul class="text-center">
                        <li><strong>BIKAT,</strong></li>
                        <li>Guzar e Quaid , rawalpindi.</li>
                    </ul>
                </div>
            </div>
            <div class="col-sm-4 text-center">
                <div class="info-box">
                    ...
                    <ul class="text-center">
                        ...
                        <li><a href="#.">uk5598060@gmail.com</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-3 col-sm-6">
                <div class="footer_panel bottom30">
                    <a href="#." class="logo bottom30"><img src="images/avatar.png" alt="logo"></a>
        ...
        <div class="copyright_simple">
            <div class="row">
                <div class="col-md-6 col-sm-5 top20 bottom20">
                    <p>Copyright &copy; 2021 <span>Ghar.Com</span>. All rights reserved.</p>
                </div>
